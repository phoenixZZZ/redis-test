...
int redis_generate_string_member(apr_pool_t *pool, redis_operating_t* operating, 
...
int redis_generate_timer_member(apr_pool_t *pool, redis_operating_t* operating, char *timeheap, 
